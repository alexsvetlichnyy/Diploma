  ...
  : G4UnstableFermiFragment(anA,aZ,Pol,ExE)
{
  ...
  G4double b9_mass = G4ParticleTable::GetParticleTable()->GetIonTable()->GetIonMass(5,9);
  std::cout << "Hello from G4B9FermiFragment, Q = " << (b9_mass - 2.*alpha_mass - proton_mass)/keV <<" keV"<< '\n';
